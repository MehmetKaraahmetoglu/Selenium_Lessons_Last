...
public class C02_ByClassNameLocator {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
        Liste yi komple yazdirmak istedigimizde normalde java yazdirirdi, burdaki sorun webelementlerinden olusan bir liste olmasi
        WebElementlerden olusan bir listeyi, direk yazdiramayiz
